...
mixin _$ContactDetails {
 ...
 int get age; String get gender; String get message; String get loc; String get location; String get name; int get timestamp; int get unread;
...
@override
int get hashCode => Object.hash(runtimeType,age,gender,message,loc,location,name,timestamp,unread);
...
@useResult
$Res call({
 int age, String gender, String message, String loc, String location, String name, int timestamp, int unread
});
...
/// Create a copy of ContactDetails
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? age = null,Object? gender = null,Object? message = null,Object? loc = null,Object? location = null,Object? name = null,Object? timestamp = null,Object? unread = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int age,  String gender,  String message,  String loc,  String location,  String name,  int timestamp,  int unread)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContactDetails() when $default != null:
return $default(_that.age,_that.gender,_that.message,_that.loc,_that.location,_that.name,_that.timestamp,_that.unread);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int age,  String gender,  String message,  String loc,  String location,  String name,  int timestamp,  int unread)  $default,) {final _that = this;
switch (_that) {
case _ContactDetails():
return $default(_that.age,_that.gender,_that.message,_that.loc,_that.location,_that.name,_that.timestamp,_that.unread);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int age,  String gender,  String message,  String loc,  String location,  String name,  int timestamp,  int unread)?  $default,) {final _that = this;
switch (_that) {
case _ContactDetails() when $default != null:
return $default(_that.age,_that.gender,_that.message,_that.loc,_that.location,_that.name,_that.timestamp,_that.unread);case _:
  return null;
...
class _ContactDetails extends ContactDetails {
  const _ContactDetails({required this.age, required this.gender, required this.message, required this.loc, required this.location, required this.name, required this.timestamp, required this.unread}): super._();
...
/// Create a copy of ContactDetails
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? age = null,Object? gender = null,Object? message = null,Object? loc = null,Object? location = null,Object? name = null,Object? timestamp = null,Object? unread = null,}) {
