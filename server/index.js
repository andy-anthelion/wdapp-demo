...
const PATH_CLIENT = '../wdapp/build/web/';
const WD_CLIENT = PATH_CLIENT + 'index.html';
...
const server = serve({
    ...
    fetch(request) {
        ...
        if(url.pathname == "/")
            return new Response(Bun.file(WD_CLIENT));
        return new Response(Bun.file(PATH_CLIENT + url.pathname));
    }
});
